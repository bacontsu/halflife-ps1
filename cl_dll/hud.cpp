...
// RENDERERS END
	...
	m_pCvarDownsample = CVAR_CREATE("te_downsample", "4", FCVAR_ARCHIVE);
	m_pCvarPalette = CVAR_CREATE("te_palette", "24", FCVAR_ARCHIVE);
	m_pCvarDither = CVAR_CREATE("te_dither", "0", FCVAR_ARCHIVE);
